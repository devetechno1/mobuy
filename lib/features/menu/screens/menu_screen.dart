                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      hideDivider: !isLoggedIn &&  Get.find<SplashController>().configModel!.refundPolicyStatus != 1 && 
                      Get.find<SplashController>().configModel!.cancellationPolicyStatus != 1 && Get.find<SplashController>().configModel!.shippingPolicyStatus != 1,
                      ),
                      ...
                      (Get.find<SplashController>().configModel!.refundPolicyStatus == 1 ) ? PortionWidget(
                        ...
                        hideDivider: !isLoggedIn && Get.find<SplashController>().configModel!.cancellationPolicyStatus != 1 && Get.find<SplashController>().configModel!.shippingPolicyStatus != 1,
                      ) : const SizedBox(),
                      ...
                      (Get.find<SplashController>().configModel!.cancellationPolicyStatus == 1 ) ? PortionWidget(
                        ...
                        hideDivider: !isLoggedIn && Get.find<SplashController>().configModel!.shippingPolicyStatus != 1,
                      ) : const SizedBox(),
